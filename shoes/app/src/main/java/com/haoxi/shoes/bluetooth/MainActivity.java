...
import com.haoxi.shoes.bluetooth.utils.ParseLeAdvData;
import com.haoxi.shoes.bluetooth.utils.SampleGattAttributes;
import com.haoxi.shoes.bluetooth.utils.SortComparator;
...
public class MainActivity extends MPermissionsActivity {
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if (bluetoothLeService.initBluetooth()) {
                ShoesApp.getInstance().setBluetoothLeService(bluetoothLeService);
        ...
        public void onServiceDisconnected(ComponentName name) {
            ShoesApp.getInstance().setBluetoothLeService(null);
        }
    };
    ...
    private void initWidget(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ShoesApp.getInstance().getBluetoothLeService().getmBluetoothAdapter().stopLeScan(leScanCallback);
                isRefreshing = false;
    ...
    private void startScanDevice() {
        ...
        isRefreshing = true;
        BluetoothLeService bluetoothLeService = ShoesApp.getInstance().getBluetoothLeService();
